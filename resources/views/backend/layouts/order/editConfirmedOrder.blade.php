...
active open
@endsection
@section('confirmed_active')
    active
@endsection
@section('confirmed_toggled')
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-right">
                                        ...
                                        <a href="{{ route('admin-pdfDownload-order',$order->id ) }}" class="btn btn-info"><i class="zmdi zmdi-print"></i></a>
                                            <form action="{{ route('confirmedOrder.update') }}" method="post">
                                            @csrf
                                            <input type="hidden" value="{{ $order->id }}" name="order_id">
                                            <div class="text-right">
                                            <select name="status" id="selectStatus" class="form-control show-tick ms select2" width="20">
                                                <option >--Select--</option>
                                                <option value="Delivered" style="color:green">Delivered</option>
                                                <option value="Cancelled" style="color:red">Cancelled</option>
                                            </select>
                                            <label for="note" id="reason" class="mt-3">Reason  of Cancelation</label>
                                            <textarea name="cancel_note" id="note" class="form-control" rows="3"></textarea>
                                            </div>
