...
@section('title')
{{ $section_description->meta_title }}
@endsection
@section('description')
{{ $section_description->meta_description }}
@endsection
@section('content')
                ...
                <div class="col-12">
                    <div class="breadcrumb_content">
                        <ul>
                            ...
                            <li> {{ strtolower(App\Section::where('id',$section_id)->value('section_name')) }}</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 order-first order-lg-last">
                    ...
                    <div class="mb-30  subcategory">
                        @if (count($sectionUnderCategories)>0)
                        @foreach ($sectionUnderCategories as $category)
                    ...
                    <div class="toolbar-shop mb-50">
                        ...
                        <div class="page-amount">
                            <p> {{ $productCount }} Products are avilable in this category</p>
                        </div>
                        <div>
                    ...
                    <div class="toolbar-shop toolbar-bottom">
                        <div class="page-amount">
                            <p>Showing 1-{{ $productCount }} results</p>
                        </div>
