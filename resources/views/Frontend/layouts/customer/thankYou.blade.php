                ...
                <div class="col-12 col-sm-12 col-md-12 col-lg-10">
                    ...
                    <div class="tab-content dashboard-content mb-20">
                        <div id="dashboard" class="tab-pane fade active show">
                            <h3 class="last-title">Your order has been successfully placed!!</h3>
                            ...
                            @endif
                            <p class="pt-4 pb-3"><h6>Thank you for your order</h6></p>

                            <p>Our representative will contact with you very soon to verify the order.</p>
